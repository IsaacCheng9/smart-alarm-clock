...
def get_alarm_input() -> str:
    ...
    if alarm_time:
        displayed_alarms = set_alarm(alarm_time, alarm_label, alarm_repeat)
        return alarm_time, alarm_label, alarm_repeat, displayed_alarms
